...
public class Client
{
    ...
    public TCP tcp;
    public UDP udp;
    public RSAParameters remoteKey;
    public (RSAParameters publicKey, RSAParameters privateKey) clientKeys;
    ...
    public Client(int _clientId)
    {
        ...
        tcp = new TCP(id);
        udp = new UDP(id);
        clientKeys = Cryptograph.GenerateKeySet();
    }
    ...
    public class TCP
    {
        ...
        public void Connect(TcpClient _socket)
        {
            ...
            PacketHandler.SendPacket(id, ServerPacket.WELCOME, new Dictionary<string, object>()
            {
                { "id", id},
                { "key", Cryptograph.KeyToString(Server.clients[id].clientKeys.publicKey)}
            }, useEncrypt: false);
        }
    ...
    public void Disconnect()
    {
        ...
        ThreadManager.ExecuteOnMainThread(() =>
        {
            EntityHandler.GetEntity<Player>(id).Destroy();
        });
